...
export const STRUCTURE_SHAPES: Partial<Record<UnitType, ShapeType>> = {
  ...
  [UnitType.Destroyer]: "cross",
  [UnitType.Cruiser]: "cross",
  [UnitType.Battleship]: "cross",
  [UnitType.Submarine]: "cross",
  [UnitType.Minelayer]: "cross",
  [UnitType.Airbase]: "square",
  [UnitType.Fighter]: "cross",
  [UnitType.TacticalBomber]: "cross",
  ...
  public createRange(
    ...
    switch (type) {
      ...
      case UnitType.CoastalBattery:
        radius =
          this.game.config().unitInfo(UnitType.CoastalBattery).range ?? 80;
        break;
