...
const unitOptions: { type: UnitType; translationKey: string }[] = [
  ...
  { type: UnitType.Cruiser, translationKey: "unit_type.cruiser" },
  { type: UnitType.Battleship, translationKey: "unit_type.battleship" },
  { type: UnitType.Submarine, translationKey: "unit_type.submarine" },
  { type: UnitType.Minelayer, translationKey: "unit_type.minelayer" },
  { type: UnitType.Carrier, translationKey: "unit_type.carrier" },
  { type: UnitType.NavalYard, translationKey: "unit_type.naval_yard" },
  {
    type: UnitType.CoastalBattery,
    translationKey: "unit_type.coastal_battery",
  },
